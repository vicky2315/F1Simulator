...
public class RaceManager : MonoBehaviour
{
    ...
    private void UpdateStandings()
    {
        carsInRace.Sort((a, b) =>
        {
            ...
            {
                float distanceA = Vector3.Distance(a.transform.position, monzaCheckpoints[checkpointCountA % monzaCheckpoints.Count].transform.position);
                float distanceB = Vector3.Distance(b.transform.position, monzaCheckpoints[checkpointCountB % monzaCheckpoints.Count].transform.position);
